...
const updateNotices = [
    {
        date: '2026-07-27',
        ja: '秋の季節のレシピに「いちごと洋梨のシャーベット（秋仕様）」を追加しました。',
        ne: 'शरद ऋतुको रेसिपीमा “स्ट्रबेरी र नासपातीको शरबत（शरद संस्करण）” थपिएको छ।'
    },
    {
        date: '2026-07-21',
        ja: '令和八年　秋の極上懐石献立を追加しました。',
        ne: 'वि.सं. २०८३ शरदकालीन विशेष काइसेकी मेनु थपिएको छ।'
    },
    {
        date: '2026-04-12',
        ja: '令和八年　夏の極上懐石の献立を追加しました。',
        ne: 'वि.सं. २०८३ ग्रीष्मकालीन विशेष काइसेकी मेनु थपिएको छ।'
    },
    {
        date: '2026-03-23',
